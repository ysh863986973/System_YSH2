    ...
    <div data-v-95ac8d30="" class="header3">
        <div data-v-95ac8d30="" class="layout clear">
            ...
            <div data-v-95ac8d30="" class="header3Nav right">|<a data-v-95ac8d30=""
                    ...
                    data-v-95ac8d30=""
                    data-v-67ef3a4a href="${pageContext.request.contextPath}/logoff" class="colorRed"
            ...
            <div data-v-95ac8d30="" class="header3User right">
                ...
                <span data-v-95ac8d30="" class="sp2">欢迎您!我亲爱的${user.email}</span>
                ...
                <div class="userInfoL left">
                    <div data-v-1cae2c34="" class="userNav">
                        ...
                        <ul data-v-1cae2c34="" class="manNav">
                            <li data-v-1cae2c34="">
                                <a data-v-1cae2c34="" href="${pageContext.request.contextPath}/myMain"
                                   class="sel">订单管理</a>
                            </li>
                            <li data-v-1cae2c34="">
                                <a data-v-1cae2c34="" href="${pageContext.request.contextPath}/myInfo" class="">个人信息</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                ...
                                <div class="noData" id="noda">
                                    ...
                                    <table cellspacing="0" cellpadding="0" border="1px">
                                        <tr class="firstTr" v-for="site in obj">
                                            ...
                                            <td>{{site.ostatus}}</td>
                                            <td>
                                                <a v-bind:href="'${pageContext.request.contextPath}/order/delete?id='+site.oid"
...
<script type="text/javascript">
    ...
    var vm = new Vue({
        ...
        methods: {
            deleteOrder: function (id) {
                window.location.href = "${pageContext.request.contextPath}/order/delete?id=" + id
            }
        }
    });
    ...
    function loadData(page) {
        $.ajax({
            type: "get",
            url: "${pageContext.request.contextPath}/order/list?page=" + page,
            dataType: "json",
            async: false,
            success: function (data) {
                if (data.condition === "1") {
                    vm.obj = data.myOrders;
