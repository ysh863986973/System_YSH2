                ...
                <div data-v-0a99943a="" class="loginType right">
                    ...
                    <div class="forms">
                        <form class="layui-form" method="post">
                            ...
                            <div data-v-0a99943a="" class="other clear"><a data-v-0a99943a="" href="#" class="right forget">忘记密码？</a></div>
                            ...
                            <div data-v-0a99943a="" class="goRegister">
                                还没有账号？<a data-v-0a99943a="" href="${pageContext.request.contextPath}/signIn">免费注册</a></div>
                        </form>
                    </div>
                </div>
            </div>
        ...
        form.on('submit(formDemo)', function(dt){
            $.ajax({
                ...
                success:function(obj) {
                    ...
                    if(obj == "1") {
                        window.location.href="${pageContext.request.contextPath}/shortRent";
                    }else {
                        alert("账号或密码错误");
