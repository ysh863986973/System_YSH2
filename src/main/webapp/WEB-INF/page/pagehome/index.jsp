        ...
        <div data-v-67ef3a4a class="layout clear">
            <div data-v-67ef3a4a class="left csdnav">
                <label data-v-67ef3a4a>
                    <a data-v-67ef3a4a href="${pageContext.request.contextPath}/login" class="colorRed">登录</a>
                    <a data-v-67ef3a4a href="javascript:void" class="colorRed">/</a>
                    <a data-v-67ef3a4a href="${pageContext.request.contextPath}/signIn" class="colorRed" style="margin-right: 10px;">注册</a>
                    <a data-v-67ef3a4a href="${pageContext.request.contextPath}/myInfo">欢迎您!我亲爱的${user.email}</a>
                    <a data-v-67ef3a4a href="#" class="colorRed">/</a>
                    <a data-v-67ef3a4a href="${pageContext.request.contextPath}/logoff" class="colorRed"
            ...
            <div data-v-67ef3a4a="" class="right phone">
                ...
                <div data-v-67ef3a4a="" class="menu">
                    <a data-v-67ef3a4a="" href="${pageContext.request.contextPath}/myMain">我的车速递</a>
                </div>
                <div data-v-67ef3a4a="">
    ...
    <div data-v-39f7f629 class="csdnav">
        <div data-v-39f7f629="" class="layout clear">
            <div data-v-39f7f629="" class="left logo">
                <a data-v-39f7f629="" href="${pageContext.request.contextPath}/index">
            ...
            <div data-v-39f7f629="" class="left navCom">
                <ul data-v-39f7f629="">
                    ...
                    <li data-v-39f7f629="">
                        <a data-v-39f7f629="" href="${pageContext.request.contextPath}/shortRent" target="_self" class="">短租自驾</a>
                    </li>
                    <li data-v-39f7f629="">
                        <a data-v-39f7f629="" href="${pageContext.request.contextPath}/index" target="_self" class="colorRed">
    ...
    <div class="banner">
        ...
        <div class="layout">
                ...
                <div class="selectCar">
                    ...
                    <div class="carCom clear">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline" style="width: 145px">
                                <select id="bmsel">
                                    <option>请选择</option>
                                    <option v-for="site in sites" :value="site.cityId">{{site.cityName}}</option>
                                </select>
                            </div>
                            <%--<div class="layui-form-item">
                    ...
                    <button class="goBtn" onclick="selectCar()">去选车</button>
                </div>
            </form>
        </div>
    </div>
                    ...
                    <div class="layui-tab-content" style="width:1200px; height:524px;">
                        <div class="layui-tab-item layui-show">
                            <div class="item carItemBig">
                                <img src="https://www.chesudi.com/static/img/ricanxuanyiDZ.5a39d59.png" onMouseOver="this.src='${pageContext.request.contextPath}/images/richan.png'" onmouseout="this.src='https://www.chesudi.com/static/img/ricanxuanyiDZ.5a39d59.png'">
                            </div>
                            <div class="item carItemSmall">
                                <img src="https://www.chesudi.com/static/img/bentianDZ.16f9310.png"  onMouseOver="this.src='${pageContext.request.contextPath}/images/bentian.png'" onmouseout="this.src='https://www.chesudi.com/static/img/bentianDZ.16f9310.png'">

                            </div>
                            <div class="item carItemSmall">
                                <img src="https://www.chesudi.com/static/img/biekeDZ-L8.573ed0f.png"  onMouseOver="this.src='${pageContext.request.contextPath}/images/sma.png'" onmouseout="this.src='https://www.chesudi.com/static/img/biekeDZ-L8.573ed0f.png'">

                            </div>
                            <div class="item carItemSmall">
                                <img src="https://www.chesudi.com/static/img/smartDZ.d4ceb60.png"  onMouseOver="this.src='${pageContext.request.contextPath}/images/bieke.png'" onmouseout="this.src='https://www.chesudi.com/static/img/smartDZ.d4ceb60.png'">

                            </div>
                            <div class="item carItemSmall">
                                <img src="https://www.chesudi.com/static/img/biekekaiyueDZ.b38a546.png"  onMouseOver="this.src='${pageContext.request.contextPath}/images/kaiyue.png'" onmouseout="this.src='https://www.chesudi.com/static/img/biekekaiyueDZ.b38a546.png'">
                            </div>
            ...
            <div data-v-01e628ca="" class="layout">
                ...
                <div data-v-01e628ca="" class="item">
                    <a data-v-01e628ca="" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=31010502003185" target="_blank">
                        <img data-v-01e628ca="" src="${pageContext.request.contextPath}/static/img/gongan.d0289dc.png">沪公网安备 31010502003185号</a>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function loadfirst(pid) {
        $.ajax({
            type: "post",
            url: "${pageContext.request.contextPath}/city/findByPid?cityPid=" + pid,
            dataType: "json",
...
<script type="text/javascript">
    ...
    $("#hcc").change(function () {
        loadsecond($(this).children('option:selected').val());
    })
...
<script type="text/javascript">
    ...
    function selectCar() {
        var getCityId = $("#bmsel").val();
        var backCityId = $("#hcs").val();
        window.location.href = "${pageContext.request.contextPath}/shortSort?getCityId=" + getCityId + "&backCityId=" + backCityId;
    }
