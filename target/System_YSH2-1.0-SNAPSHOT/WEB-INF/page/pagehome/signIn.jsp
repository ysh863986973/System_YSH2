    ...
    <div data-v-95c8bc32="" data-v-676ecf83="" class="header2">
        <div data-v-95c8bc32="" class="layout clear">
            <div data-v-95c8bc32="" class="left logo">
                <a data-v-95c8bc32="" href="${pageContext.request.contextPath}/index">
                    <img data-v-95c8bc32=""
            ...
            <a data-v-95c8bc32="" href="${pageContext.request.contextPath}/index" class="right">回到首页&gt;</a>
        </div>
    </div>
        ...
        <div data-v-676ecf83="" class="layout">
            <div data-v-676ecf83="" class="registerCom clear">
                <div data-v-676ecf83="" class="registerType left">
                    ...
                    <form class="layui-form" action="${pageContext.request.contextPath}/user/signIn" method="post">
                        <div class="layui-form-item">
                            <i class="layui-icon layui-icon-user" style="font-size: 20px; "></i>
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <input type="text" name="email" lay-verify="email" placeholder="请输入电子邮箱，用于登录和找回密码"
                                           autocomplete="off" class="layui-input" id="email" width="10px">
                                </div>
                            </div>
                            <div align="right">
                                <a onclick="sendEmail()" class="btn btn-default" role="button">获取验证码</a>
                            </div>
                        </div>
                        <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <input type="repassword" lay-verify="repassword" placeholder="请再次输入密码"
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <input type="text" name="captcha" lay-verify="captcha" autocomplete="off"
                ...
                <div data-v-676ecf83="" class="registerImg right">
                    <h2 data-v-676ecf83="">已有车速递账号？
                        <a data-v-676ecf83="" href="${pageContext.request.contextPath}/login">立即登录&nbsp;&gt;&gt;</a>
